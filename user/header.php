    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <?php
                $sqll=mysqli_query($con,"SELECT * FROM `category` WHERE 1");
                while($row=mysqli_fetch_array($sqll)){
                ?>
                <li><a href="prodact.php?rn=<?php echo$row['id'];?>">
                    <i class="uil uil-files-landscapes"></i>
                    <span class="link-name"><?php echo$row['name'];?></span>
                </a></li>
                <?php
                }
                ?>
                ...
                <i class="fa-solid fa-cart-shopping"></i>
                    <span class="link-name">stor</span>
                </a></li>
                <li><a href="order.php">
                <i class="fa-regular fa-rectangle-list"></i>
                    <span class="link-name">order</span>
                </a></li>
                <li><a href="Chat/chat.php">
            ...
            <div class="overview">
                ...
                <div class="boxes">
                    ...
                    <i class="fa-solid fa-cart-shopping"></i>
                        ...
                        <span class="number">
                            <?php 
                        $sqli="SELECT COUNT(*) as total FROM store WHERE `id_user`='$_SESSION[user_id]'";
